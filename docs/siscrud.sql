...
REPLACE INTO `aluno` (`matricula`, `nome_aluno`, `nome_pai`, `nome_mae`, `dt_nasc`, `sexo_aluno`, `rg_aluno`, `cpf_aluno`) VALUES
	(2, 'MARIANA DA SILVA MALDONADO', 'ROBERTO RODRIGUES', 'RITA DE AMARAL', '1987-02-02', 'F', 656556565, '656555222'),
	(4, 'VITOR HUGO MAXWELL DE OLIVEIRA', 'CARLOS DE SOUZA BALINTER', 'MARIA EDUARDA FOXILIN', '1975-07-06', 'M', 979734343, '979873434'),
	(3, 'MARCELO PRADO DA SILVA', 'ROBERTO SILVEIRA', 'RENATA PIMENTEL DAS GRAÃ‡AS', '2015-10-02', 'M', 987979333, '9879879333'),
	(5, 'RONALDO DA SILVA', 'RONALDO AMÃ‚NCIO', 'RENATA PIMENTEL DAS GRAÃ‡AS', '2015-02-10', 'M', 987979333, '9879879333'),
	(6, 'DANIEL DA CONCEIÃ‡ÃƒO', 'JULIO DA SILVA TELLES', 'MARIA DE FÃTIMA', '1987-02-02', 'M', 987979333, '9879879333');
...
CREATE TABLE `siscrud`.`funcionario` (
  `id_func` INT(11) NULL AUTO_INCREMENT , 
  `nome_func` VARCHAR(50) NOT NULL , 
  `sexo_func` VARCHAR(25) NOT NULL , 
  `sal_func` VARCHAR(40) NOT NULL , 
  `escolaridade_func` VARCHAR(100) NOT NULL , 
  PRIMARY KEY (`id_func`)
  ) ENGINE = InnoDB;
